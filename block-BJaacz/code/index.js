...
*/
function addTwoToArray(arrNum) {
  let arrTwoAdded = [];
  for(let element of arrNum) {
    arrTwoAdded.push(addTwo(element));
  }
  return arrTwoAdded;
}
...
*/
function addThreeToArray(arrNum) {
  let arrThreeAdded = [];
  for(let element of arrNum) {
    arrThreeAdded.push(addThree(element));
  }
  return arrThreeAdded;
}
...
/*
  Create a function named addFiveToArray which accepts:
    ...
    - while doing so use the funciton addThree
*/
function addFiveToArray(arrNum) {
  let arrFiveAdded = [];
  for(let element of arrNum) {
    arrFiveAdded.push(addFive(element));
  }
  return arrFiveAdded;
}
...
*/
function changeArray(arrNum, cb) {
  let newArr = [];
  for(let element of arrNum) {
...
callMe(function() {console.log('Hi')});
...
function isAdult(personObj) {
  return personObj.age > 18 ? true : false;
}
...
*/
function isMale(gradeObj) {
  return gradeObj.sex === 'M' ? true : false;
}
...
*/
function isFemale(gradeObj) {
  return gradeObj.sex === 'F' ? true : false;
}
...
*/
function isGradeA(gradeObj) {
  return gradeObj.grade > 12 ? true : false;
}
...
*/
function isGradeB(gradeObj) {
  return gradeObj.grade > 8 && gradeObj.grade <= 12 ? true : false;
}
...
*/
function isGradeC(gradeObj) {
  return gradeObj.grade <= 8 ? true : false;
}
...
*/
function filterAdult(peopleObj) {
  let adultArr = [];
  for(let person of peopleObj) {
    if(isAdult(person)) {
      adultArr.push(person);
    }
  }
  return adultArr;
}
...
*/
function filterMale(gradesObj) {
  let maleArr = [];
  for(let grade of gradesObj) {
    if(isMale(grade)) {
      maleArr.push(grade);
    }
  }
...
*/
function filterFemale(gradesObj) {
  let femaleArr = [];
  for(let grade of gradesObj) {
    if(isFemale(grade)) {
...
*/
function filterGradeA(gradesObj) {
  let gradeA = [];
  for(let grade of gradesObj) {
    if(isGradeA(grade)) {
      gradeA.push(grade);
...
*/
function filterGradeB(gradesObj) {
  let gradeB = [];
  for(let grade of gradesObj) {
    if(isGradeB(grade)) {
      gradeB.push(grade);
...
*/
function filterGradeC(gradesObj) {
  let gradeC = [];
  for(let grade of gradesObj) {
    if(isGradeC(grade)) {
      gradeC.push(grade);
